  ...
  async (_0x5cb388, _0x302ad5) => {
    try {
      try {
        ...
        if (!_0x557719) {
          return man.reply("Provide me a query ex Who is FAXI");
        }
...
smd(
  ...
  async (_0x42b3b8, _0x3f3887) => {
    try {
      ...
      if (!_0x1b0897) {
        return _0x42b3b8.reply("Provide me a query ex Who is FAXI");
      }
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/mrbot-59/FAXI-MDd"
      );
      let _0x1c73f9 = (
        "\nFAXI-MD A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        ...
        "\n  *❲❒❳ Repo:* _https://github.com/mrbot-59/FAXI-MD_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
  ...
  async (_0x2acf30) => {
    try {
      if (
        ...
        if (
          _0x2acf30.reply_text.includes("FAXI-MD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
