  ...
  smd(
    ...
    async (message, input) => {
      try {
        ...
        return await message.send(`*FAXI-MD ʙᴀʀᴅ ᴀɪ:*\n ${result}`, { quoted: message });
      } catch (error) {
      ...
      try {
        if (
          ...
          if (
            ...
            _0x2dfb59[0].includes("FAXI-MD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
